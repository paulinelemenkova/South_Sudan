...
\address[1]{%
Laboratory of Image Synthesis and Analysis, \'{E}cole polytechnique de Bruxelles, Université Libre de Bruxelles (ULB),  Building L, Campus du Solbosch, ULB--LISA CP165/57, Avenue Franklin D. Roosevelt 50, \linebreak 1050 Brussels, Belgium; polina.lemenkova@ulb.be or polina.lemenkova@plus.ac.at;  %MDPI: Please confirm if both emails need to be retained. % Author's reply: yes, both emails are necessary.
...
\firstnote{\hangafter=1 \hangindent=1.05em \hspace{-0.82em} Current Affiliation: Department of Geoinformatics, Universität Salzburg, Schillerstraße 30, \linebreak A-5020 Salzburg, Austria.} 
...
\newblock In {\em Fundamentals of Digital Image Processing}; John Wiley \&
  Sons, Ltd.:  \hl{Hoboken, NJ, USA,} %We added the location of publisher. Please confirm
...
\newblock In Proceedings of the 2014 IEEE Geoscience and Remote Sensing
  Symposium,  \hl{2014}; pp. 2727--2730.  %MDPI: Please add the location (city, country) and date (day, month) of the conference. Please add for all conferences.
...
\newblock In Proceedings of the 2019 IEEE International Conference on Aerospace
  Electronics and Remote Sensing Technology (ICARES),  \hl{2019}; pp. 1--5.
...
\newblock In Proceedings of the 2011 6th International Workshop on the Analysis
  of Multi-temporal Remote Sensing Images (Multi-Temp),  \hl{2011}; pp. 205--208.
...
\newblock In Proceedings of the 2022 Seventh International Conference on
  Informatics and Computing (ICIC),  \hl{2022}; pp. 1--6.
...
\newblock In Proceedings of the 2021 International Conference on Computer
  Information Science and Artificial Intelligence (CISAI),  \hl{2021}; pp.~268--272.
...
\newblock In Proceedings of the 2007 3rd International Conference on Recent
  Advances in Space Technologies,  \hl{2007}; pp. 636--640.
...
\newblock In Proceedings of the 2016 IEEE International Geoscience and Remote
  Sensing Symposium (IGARSS),  \hl{2016}; pp. 4059--4062.
...
\newblock In Proceedings of the 2016 2nd International Conference on Next
  Generation Computing Technologies (NGCT),  \hl{2016}; pp. 765--771.
...
\newblock Fusion detection of ship targets in low resolution multi-spectral
  images.
\newblock In Proceedings of the 2016 IEEE International Geoscience and Remote
  Sensing Symposium (IGARSS),  \hl{2016}; pp. 6545--6548.
...
\newblock In Proceedings of the  12th International Conference on
  Pattern Recognition,  \hl{1994}; Volume~1, pp. 449--453.
...
Tzotsos, A.; Karantzalos, K.; Argialas, D. Multiscale Segmentation and
  ...
  Features.
\newblock In {\em Scale Issues in Remote Sensing}; John Wiley \& Sons, Ltd.:  \hl{Hoboken, NJ, USA,} 
...
\newblock In Proceedings of the 2022 30th Telecommunications Forum (TELFOR),
  \hl{2022}; pp. 1--4.
...
\newblock In Proceedings of the 2017 International Conference on Security,
  Pattern Analysis, and Cybernetics (SPAC),  \hl{2017}; pp. 175--180.
...
\newblock In Proceedings of the 2018 11th International Congress on Image and
  Signal Processing, BioMedical Engineering and Informatics (CISP-BMEI),  \hl{2018};
  pp. 1--5.
...
\newblock In Proceedings of the 2020 5th International Conference on
  Mechanical, Control and Computer Engineering (ICMCCE),  \hl{2020}; pp. 2219--2223.
...
\newblock In Proceedings of the 2011 International Conference on Electronics,
  Communications and Control (ICECC),  \hl{2011}; pp. 2170--2173.
...
\newblock In Proceedings of the 2015 12th International Computer Conference on
  Wavelet Active Media Technology and Information Processing (ICCWAMTIP),
  \hl{2015}; pp. 307--310.
...
\newblock In Proceedings of the 2011 4th International Congress on Image and
  Signal Processing,  \hl{2011}; Volume~2, pp. 1123--1126.
...
\newblock In Proceedings of the 2018 IEEE MIT Undergraduate Research Technology
  Conference (URTC),  \hl{2018}; pp. 1--5.
