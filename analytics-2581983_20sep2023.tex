...
% Attention: title altered % Scripting Algorithms for Workflow Automation in Satellite Image Processing for Environmental Analytics % Author's reply: yes, new Title is correct.
...
\end{adjustwidth}
%}
\caption{Segmentation %MDPI: Please use commas to separate thousands for numbers with five or more digits (not four digits) in the picture, e.g., "10000" should be "10,000". % Author's reply: Figure 6 is redone and corrected as requested: commas are used to separate thousands for numbers with five or more digits.
...
\funding{The APC was funded by the Editorial Office of Analytics, Multidisciplinary Digital Publishing Institute (MDPI).} %MDPI: Please add: ``This research received no external funding'' or ``This research was funded by NAME OF FUNDER grant number XXX.'' and and ``The APC was funded by XXX''. Check carefully that the details given are accurate and use the standard spelling of funding agency names at \url{https://search.crossref.org/funding}, any errors may affect your future funding.
...
\section[\appendixname~\thesection]{GRASS GIS Scripts for Image Processing, Segmentation and Classification}\label{AppS}
...
\newblock Available online: URL: https://www.afro.who.int/health-topics/disease-outbreaks/outbreaks-and-other-emergencies-updates (accessed on 10 August 2023). %MDPI: Please add URL and the access date. % Author's reply: yes, added both.
