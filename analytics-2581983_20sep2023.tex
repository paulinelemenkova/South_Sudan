...
\address[1]{%
Laboratory of Image Synthesis and Analysis, \'{E}cole polytechnique de Bruxelles, Université Libre de Bruxelles (ULB),  Building L, Campus du Solbosch, ULB--LISA CP165/57, Avenue Franklin D. Roosevelt 50, \linebreak 1050 Brussels, Belgium; \hl{polina.lemenkova@ulb.be} or \hl{polina.lemenkova@plus.ac.at};  %MDPI: Please confirm if both emails need to be retained.
