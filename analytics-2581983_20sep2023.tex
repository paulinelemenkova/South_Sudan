...
{In contrast to the previously used Python and R tools, the GRASS GIS presents a more powerful toolset for image processing. % Please check intended meaning is retained. % Author's reply: yes, the intended meaning is retained.
...
The segmentation of a satellite images is based on  probabilistic modelling, which is applicable to a wide range of image structures~\cite{Buscombe}.  % Please check intended meaning is retained. % Author's reply: yes, the intended meaning is retained.
...
\end{adjustwidth}
\caption{Surficial geologic units in South Sudan and surrounding area. Software: QGIS version 3.32.  %MDPI: Please state the version number of the software. % Author's reply: yes, added.
...
The Sudd wetlands are formed as a downstream of Lake Victoria and Lake Albert in the Nile Basin in the Sudd geologic province~\cite{1792135} (Figure \ref{fig03}). % Please check intended meaning is retained. % Author's reply: yes, the intended meaning is retained.
...
Climate factors affect the Sudd swamps through water balance~\cite{SutcliffeParks} and evaporation~\cite{DIVITTORIO2021100922}. {The average temperature is 18.5 $^\circ$C, %MDPI: Please confirm  if C should be $^\circ$C. % Author's reply: yes, exactly (corrected).
...
\end{adjustwidth}
\caption{Geologic provinces in South Sudan and surroundings. Software: QGIS version 3.32.  %MDPI: Please state the version number of the software. % Author's reply: yes, added.
Data source: USGS. Map source: author.
\label{fig03}}
\end{figure}
...
Climate--hydrological fluctuations have cumulative environmental effects on the sustainability of the Sudd ecosystems. % Please check intended meaning is retained. % Author's reply: yes, the intended meaning is retained.
...
\end{adjustwidth}
\caption{Methodological flowchart scheme. Software: R version 4.3.1. %MDPI: Please state the version number of the software. % Author's reply: yes, added.
Graph source: author.
\label{fig04}}
\end{figure}
...
The Landsat images from 8 and 9 OLI/TIRS sensors were downloaded from the EarthExplorer repository: URL \href{https://earthexplorer.usgs.gov/}{https://earthexplorer.usgs.gov/} (accessed on 30 July 2023). %MDPI: Please provide the access date of the URL in the following format: "URL (accessed on Day Month Year)". % Author's reply: yes, corrected.
 {The EarthExplorer} aims at Earth observation data, collected for the multiscale monitoring of Earth-related processes using remote sensing data. % Please check intended meaning is retained. % Author's reply: yes, the intended meaning is retained.
 It is supported by the USGS, which coordinates and promotes storage of the datasets in digital format for queries. It enables downloading the satellite images and provides cartographic information for data. Besides  Landsat, it also supports other remote sensing products, such as radar data, aerial imagery, Digital Elevation Models (DEM), Advanced Very High Resolution Radiometer (AVHRR), etc. {The reason for the nine satellite images consists in demonstrating the dynamics of the land cover types within a comparable period. Another reason consists in the available images with low cloudiness, which are below 10\% for the scenes takes in the appropriate seasons.} The images cover 9 years, from 2015 to 2023, Figure \ref{fig05}. 
...
%}
\end{adjustwidth}
\caption{The Sudd wetlands in the Landsat images in natural colours for 8 recent years (2015--2023). {The acquisition period of each image is as follows: (1) 8 January 2015,  %MDPI: we changed the format of date according to our regulations. Please confirm. % Author's reply: yes, confirm.
...
The choice of image data is explained by the two criteria: (1) the cloudiness of the image is below 10\% for all the scenes; (2) the images are captured in the dry period to objectively assess the postflood scenario. % Please check intended meaning is retained. % Author's reply: yes, the intended meaning is retained.
The wet period of the Sudd region is accompanied by heavy rainfalls that last throughout the summer period. % Please check intended meaning is retained. % Author's reply: yes, the intended meaning is retained.
...
{The atmospheric correction method included the algorithms of the embedded GRASS GIS module `i.landsat.toar'. This module enables to convert the DN pixel values to reflectance values using DOS1 from Digital Number (DN) to reflectance. % Please check intended meaning is retained. % Author's reply: yes, the intended meaning is retained.
Before creating an RGB composite, it is important to perform the atmospheric correction and thus  convert the digital number data (DN) to reflectance or radiance. % Please check intended meaning is retained. % Author's reply: yes, the intended meaning is retained.
...
\midrule
UTM & 36 & WGS84 & WGS84 & 915,615 %MDPI: We added commas to separate thousands for numbers with five or more digits. Please confirm. % Author's reply: yes, confirm.
...
%\begin{tablenotes}
      ...
      \noindent\footnotesize
      	  {Abbreviations in Table \ref{tab01}:}  Proj---projection; Dat.---datum; Ellips---ellipsoid; N---north; S---south; W---west; E---east; nsres---resolution in north--south direction; ewres---resolution in east--west direction; cols---columns. % Please check intended meaning is retained. % Author's reply: yes, the intended meaning is retained.
   % \end{tablenotes}
 % \end{threeparttable}
\end{table}
...
Thus, clustering presents the advanced object-based detection method. which creates signatures for the next step of image classification, which computes the distance between  pixels using the similarity method. % Please check intended meaning is retained. % Author's reply: yes, the intended meaning is retained.
...
%\begin{tablenotes}
      \noindent\footnotesize
      	  {Notation for Table \ref{tab03}}: %MDPI: We changed Table 2 to Table 3. Please confirm this revision. % Author's reply: yes, confirm.
 The Landsat images were selected with cloudiness below 10\% to achieve maximal distinguishability of the contours of the images. % Please check intended meaning is retained. % Author's reply: yes, the intended meaning is retained.
 %   \end{tablenotes}
%  \end{threeparttable}
\end{table}
...
{The grouping decision}  is made using the features of  pixels that match target classes (`segment'/`not segment'), colour, distance to the threshold in pixels, and the spectral reflectance of the pixel. % Please check intended meaning is retained. % Author's reply: yes, the intended meaning is retained.
...
{The wetland systems of the Sudd} are one of the most important ecosystems of South Sudan and are included in the list of the Ramsar Convention on Wetlands of International Importance Especially as Waterfowl Habitat %MDPI: Please confirm if the italics is unnecessary and can be removed. The following highlights are the same. % Author's reply: the italics can be removed (I removed it).
...
The floods presented in simulated models are also related to the drought periods, which are reflected in the periods of  minimum flood extent in the years 2015, 2019, and 2021. % Please check intended meaning is retained. % Author's reply: yes, the intended meaning is retained.
This also supports the findings from previous works on climate--environmental relationships and report on the impact of the Sudd wetlands on atmospheric moisture fluxes in South Sudan through evaporation~\cite{Mohamed}. % Please check intended meaning is retained. % Author's reply: yes, the intended meaning is retained.
The presented geospatial visualisation supported sustainable monitoring of the Sudd wetlands and the mapping of the inundated areas using segmentation and classification as comparative analysis and NDVI calculation to detect vegetation areas. % Please check intended meaning is retained. % Author's reply: yes, the intended meaning is retained.
...
\funding{The APC was funded by the Multidisciplinary Digital Publishing Institute (MDPI).} %MDPI: Please add: ``This research received no external funding'' or ``This research was funded by NAME OF FUNDER grant number XXX.'' and and ``The APC was funded by XXX''. Check carefully that the details given are accurate and use the standard spelling of funding agency names at \url{https://search.crossref.org/funding}, any errors may affect your future funding.

\institutionalreview{Not applicable.}

\informedconsent{Not applicable.}

\dataavailability{GRASS GIS scripts for image segmentation, clustering and classification, clustering results, computed kappa parameters, and errors matrices are available in the GitHub repository: \href{https://github.com/paulinelemenkova/Sudd_South_Sudan_Image_Analysis}{https://github.com/paulinelemenkova/Sudd\_South\_Sudan\_Image\_Analysis}  (accessed on 10 August 2023).}  %MDPI: Please provide the access date of the URL in the following format: "URL (accessed on Day Month Year)".
...
\tablesize{\footnotesize}
    %\centering
    \caption{Calculated error matrix and kappa parameter for accuracy assessment of the classification results for Landsat 8 image on 2015 %MDPI: Please confirm if the bold is unnecessary and can be removed. The following highlights are the same. % Author's reply: yes, bold can be removed (I removed it).
...
\newcolumntype{L}{>{\raggedright\arraybackslash}X}
    ...
    \toprule
      ...
      &&&&&&&&&&&\\[-2ex]
        Class 1 & 733,990 %MDPI: Please add an explanation for color in the table footer. If the color is unnecessary, please remove it. The following highlights are the same. % Author's reply: the color is not necessary and removed.
 & 71,250 & 51,480 & 7839 & 46,757 & 700,709 & 113,227 & 113,324 & 9887 & 5118 & 1,853,581 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 2 & 26,060 & 6727 & 35,538 & 26,438 & 364,431 & 2,554,250 & 860,056 & 672,721 & 31,768 & 28,371 & 4,606,360 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 3 & 126,808 & 1,031,318 & 265,035 & 526,075 & 315,900 & 19,612 & 264,441 & 41,069 & 252,749 & 7260 & 2,850,267 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 4 & 49,698 & 1,019,916 & 414,261 & 1,502,475 & 729,561 & 151,428 & 544,346 & 56,599 & 699,290 & 36,435 & 5,204,009 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 5 & 55,812 & 124,601 & 65,706 & 587,382 & 1,069,099 & 2,306,196 & 1,927,058 & 744,408 & 55,621 & 67,236 & 7,003,119 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 6 & 52,480 & 54,546 & 5866 & 311,905 & 743,280 & 2,588,755 & 1,866,894 & 982,650 & 119,871 & 76,889 & 6,803,136 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 7 & 24,987 & 458,562 & 337,404 & 1,432,717 & 276,379 & 72,536 & 202,169 & 59,283 & 1,294,871 & 6729 & 4,165,637 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 8 & 85,044 & 497,573 & 2,216,937 & 118,633 & 30,004 & 449 & 10,108 & 1598 & 90,003 & 1007 & 3,051,356 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 9 & 5751 & 10,876 & 1737 & 36,475 & 89,652 & 424,421 & 705,550 & 1,286,583 & 70,834 & 17,102 & 2,648,981 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 10 & 19,907 & 13,236 & 51,275 & 160,668 & 121,074 & 40,570 & 76,701 & 87,681 & 861,525 & 291 & 1,432,928 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        ColSum & 1,180,537 & 3,288,605 & 3,445,239 & 4,710,607 & 3,786,137 & 8,858,926 & 6,570,550 & 4,045,916 & 3,486,419 & 246,438 & 39,619,374 \\ %\midrule
       % \bottomrule
...
\begin{table}[H] 
    ...
    %\centering
    \caption{Calculated error matrix and kappa parameter for accuracy assessment of the classification results for Landsat 8 image on 2016 using `r.kappa' module of GRASS GIS.}%\label{tab03}} % Author's reply: yes, bold can be removed (I removed it).
\newcolumntype{L}{>{\raggedright\arraybackslash}X}
    \begin{adjustwidth}{-\extralength}{0cm}
 	\begin{tabularx}{\fulllength}{lllllllllllL}
    \toprule
        \textbf{cat\#} & \textbf{Class 1} & \textbf{Class 2} & \textbf{Class 3} & \textbf{Class 4} & \textbf{Class 5} & \textbf{Class 6} & \textbf{Class 7} & \textbf{Class 8} & \textbf{Class 9} & \textbf{Class 10} & \textbf{RowSum} \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 1 & 780,231 & 220,046 & 154,297 & 83,530 & 30,508 & 5503 & 20,356 & 2895 & 47,941 & 1275 & 1,346,582 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 2 & 99,741 & 1,580,160 & 638,455 & 893,432 & 63,464 & 1502 & 16,019 & 1711 & 347,409 & 2430 & 3,644,323 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 3 & 45,287 & 105,436 & 146,747 & 352,943 & 857,966 & 1,395,889 & 842,830 & 283,690 & 379,210 & 41,515 & 4,451,513 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 4 & 35,525 & 99,491 & 19,632 & 174,655 & 357,086 & 3,414,838 & 689,202 & 854,448 & 255,453 & 45,549 & 5,945,879 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 5 & 62,103 & 104,822 & 101,515 & 593,389 & 1,081,257 & 1,214,029 & 1,864,351 & 467,083 & 179,258 & 81,250 & 5,749,057 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 6 & 78,202 & 734,566 & 2,116,828 & 415,473 & 20,173 & 166 & 6818 & 564 & 101,522 & 2036 & 3,476,348 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 7 & 34,081 & 325,250 & 183,816 & 1,522,681 & 609,621 & 148,043 & 895,476 & 76,289 & 838,978 & 29,955 & 4,664,190 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 8 & 20,087 & 100,341 & 47,817 & 255,331 & 336,311 & 2,069,073 & 1,207,148 & 1,054,234 & 176,795 & 22,133 & 5,289,270 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 9 & 26,399 & 62,204 & 48,815 & 358,068 & 358,608 & 529,045 & 819,897 & 518,414 & 845,407 & 14,161 & 3,581,018 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 10 & 4591 & 43,312 & 37,546 & 143,710 & 82,955 & 93,770 & 258,290 & 809,648 & 410,504 & 6326 & 1,890,652 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        ColSum & 1,186,247 & 3,375,628 & 3,495,468 & 4,793,212 & 3,797,949 & 8,871,858 & 6,620,387 & 4,068,976 & 3,582,477 & 246,630 & 40,038,832 \\ %\midrule
        \noalign{\hrule height 1.0pt} 
    \end{tabularx}
    \end{adjustwidth}
\end{table}
...
\begin{table}[H] 
    ...
    %\centering
    \caption{Calculated error matrix and kappa parameter for accuracy assessment of the classification results for Landsat 8 image on 2017 using `r.kappa' module of GRASS GIS.}%\label{tab03}} % Author's reply: yes, bold can be removed (I removed it).
\newcolumntype{L}{>{\raggedright\arraybackslash}X}
    \begin{adjustwidth}{-\extralength}{0cm}
 	\begin{tabularx}{\fulllength}{lllllllllllL}
    \toprule
        \textbf{cat\#} & \textbf{Class 1} & \textbf{Class 2} & \textbf{Class 3} & \textbf{Class 4} & \textbf{Class 5} & \textbf{Class 6} & \textbf{Class 7} & \textbf{Class 8} & \textbf{Class 9} & \textbf{Class 10} & \textbf{RowSum} \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 1 & 714,689 & 117,487 & 52,980 & 29,136 & 14,787 & 67,746 & 17,701 & 9756 & 14,785 & 723 & 1,039,790 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 2 & 29,352 & 89,841 & 42,227 & 189,497 & 504,534 & 2,227,043 & 827,928 & 594,172 & 32,439 & 44,234 & 4,581,267 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 3 & 132,797 & 1,146,691 & 330,041 & 822,072 & 207,013 & 12,648 & 202,651 & 11,771 & 1,125,908 & 7090 & 3,998,682 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 4 & 41,460 & 802,806 & 164,039 & 1,157,656 & 1,081,506 & 581,552 & 1,024,952 & 173,449 & 519,751 & 25,839 & 5,573,010 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 5 & 31,282 & 101,832 & 47,418 & 331,621 & 491,478 & 1,274,293 & 1,413,071 & 693,162 & 42,470 & 39,397 & 4,466,024 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 6 & 94,598 & 767,242 & 1,889,767 & 803,189 & 138,593 & 5507 & 58,560 & 6832 & 831,596 & 3347 & 4,599,231 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 7 & 60,993 & 201,077 & 890,179 & 350,265 & 126,975 & 21,032 & 61,723 & 47,984 & 720,003 & 432 & 2,480,663 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 8 & 56,736 & 177,652 & 99,278 & 980,998 & 910,525 & 1,832,830 & 1,627,262 & 653,205 & 200,345 & 67,755 & 6,606,586 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 9 & 28,932 & 33,432 & 11,456 & 142,960 & 309,440 & 2,717,290 & 1,130,225 & 1,143,763 & 76,522 & 52,290 & 5,646,310 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 10 & 4903 & 29,081 & 7521 & 51,253 & 49,527 & 129,146 & 315,224 & 775,406 & 94,041 & 6616 & 1,462,718 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        ColSum & 1,195,742 & 3,467,141 & 3,534,906 & 4,858,647 & 3,834,378 & 8,869,087 & 6,679,297 & 4,109,500 & 3,657,860 & 247,723 & 4,045,4281 \\ %\midrule
        \noalign{\hrule height 1.0pt} 
    \end{tabularx}
    \end{adjustwidth}
\end{table}
...
%\footnotesize
    %\centering
    \caption{Calculated error matrix and kappa parameter for accuracy assessment of the classification results for Landsat 8 image on 2018 using `r.kappa' module of GRASS GIS.}%\label{tab03}} % Author's reply: yes, bold can be removed (I removed it).
\newcolumntype{L}{>{\raggedright\arraybackslash}X}
    \begin{adjustwidth}{-\extralength}{0cm}
 	\begin{tabularx}{\fulllength}{lllllllllllL}
    \toprule
         \textbf{cat\#} & \textbf{Class 1} & \textbf{Class 2} & \textbf{Class 3} & \textbf{Class 4} & \textbf{Class 5} & \textbf{Class 6} & \textbf{Class 7} & \textbf{Class 8} & \textbf{Class 9} & \textbf{Class 10} & \textbf{RowSum} \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 1 & 732,406 & 145,516 & 55,377 & 18,756 & 2042 & 567 & 2028 & 265 & 3889 & 540 & 961,386 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 2 & 42,867 & 83,461 & 39,794 & 120,546 & 646,654 & 1,668,545 & 60,5985 & 381,538 & 67,729 & 44,928 & 3,702,047 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 3 & 50,806 & 72,438 & 243,34 & 192,753 & 550,591 & 3,041,550 & 1,180,439 & 877,680 & 45,519 & 67,934 & 6,104,044 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 4 & 39,524 & 549,507 & 130,403 & 1,162,081 & 956,566 & 163,501 & 1,005,861 & 76,938 & 592,355 & 40,140 & 4,716,876 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 5 & 19,153 & 74,871 & 29,427 & 184,968 & 292,231 & 1,738,221 & 1,323,091 & 903,817 & 42,208 & 24,979 & 4,632,966 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 6 & 103,865 & 1,380,744 & 464,199 & 991,808 & 155,944 & 2218 & 115,542 & 2619 & 675,785 & 4254 & 3,896,978 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 7 & 108,450 & 727,966 & 2,543,054 & 684,347 & 22,111 & 767 & 13,922 & 755 & 586,134 & 1725 & 4,689,231 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 8 & 40,667 & 144,063 & 127,960 & 1,069,080 & 804,237 & 591,309 & 1,066,923 & 232,496 & 725,319 & 28,954 & 4,831,008 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 9 & 19,387 & 60,859 & 25,457 & 154,727 & 238,558 & 1,584,571 & 993,358 & 960,600 & 88,933 & 25,916 & 4,152,366 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 10 & 24,735 & 80,861 & 21,160 & 165,180 & 115,558 & 65,516 & 258,729 & 595,195 & 693,860 & 6799 & 2,027,593 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        ColSum & 1,181,860 & 3,320,286 & 3,461,165 & 4,744,246 & 3,784,492 & 8,856,765 & 6,565,878 & 4,031,903 & 3,521,731 & 246,169 & 39,714,495 \\% \midrule
        \noalign{\hrule height 1.0pt} 
    \end{tabularx}
    \end{adjustwidth}
\end{table}
...
%\footnotesize
    %\centering
    \caption{Calculated error matrix and kappa parameter for accuracy assessment of the classification results for Landsat 8 image on 2019 using `r.kappa' module of GRASS GIS.}%\label{tab03}} % Author's reply: yes, bold can be removed (I removed it).
\newcolumntype{L}{>{\raggedright\arraybackslash}X}
    \begin{adjustwidth}{-\extralength}{0cm}
 	\begin{tabularx}{\fulllength}{lllllllllllL}
    \toprule
        \textbf{cat\#} & \textbf{Class 1} & \textbf{Class 2} & \textbf{Class 3} & \textbf{Class 4} & \textbf{Class 5} & \textbf{Class 6} & \textbf{Class 7} & \textbf{Class 8} & \textbf{Class 9} & \textbf{Class 10} & \textbf{RowSum} \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 1 & 718,640 & 203302 & 172,239 & 93,576 & 43,600 & 4256 & 18,785 & 1009 & 154,123 & 961 & 1,410,491 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 2 & 125,598 & 1,493,295 & 662,957 & 875,909 & 62,791 & 233 & 12,810 & 1003 & 199,881 & 2890 & 3,437,367 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 3 & 54,049 & 77,429 & 71,198 & 263,136 & 915,884 & 1,601,573 & 838,669 & 292,464 & 542,080 & 38,583 & 4,695,065 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 4 & 54,698 & 420,455 & 224,468 & 1,593,385 & 860,119 & 197,570 & 1,208,920 & 145,740 & 498,281 & 68,378 & 5,272,014 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 5 & 100,175 & 681,102 & 2,082,822 & 353,990 & 9774 & 12 & 1168 & 33 & 55,344 & 1488 & 3,285,908 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 6 & 62,037 & 74,841 & 42,628 & 229,455 & 708,692 & 3,498,641 & 1,282,209 & 997,764 & 207,553 & 73,493 & 7,177,313 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 7 & 27,615 & 96,635 & 47,774 & 265,935 & 444,419 & 2,280,163 & 1,435,551 & 1,089,070 & 182,786 & 27,049 & 5,896,997 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 8 & 22,403 & 103,576 & 69,604 & 564,151 & 491,174 & 491,554 & 1,015,617 & 231,168 & 782,133 & 20,739 & 3,792,119 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 9 & 7734 & 84,827 & 34,720 & 226,934 & 165,732 & 728,783 & 621,082 & 968,785 & 172,290 & 5761 & 3,016,648 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 10 & 8316 & 75,416 & 46,918 & 267,452 & 80,567 & 52,556 & 124,414 & 300,513 & 716,496 & 6747 & 1,679,395 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        ColSum & 1,181,265 & 3,310,878 & 3,455,328 & 4,733,923 & 3,782,752 & 8,855,341 & 6,559,225 & 4,027,549 & 3,510,967 & 246,089 & 39,663,317 \\ %\midrule
        \noalign{\hrule height 1.0pt} 
    \end{tabularx}
    \end{adjustwidth}
\end{table}
...
%\footnotesize
    %\centering
    \caption{Calculated error matrix and kappa parameter for accuracy assessment of the classification results for Landsat 8 image on 2020 using `r.kappa' module of GRASS GIS.}%\label{tab03}} % Author's reply: yes, bold can be removed (I removed it).
\newcolumntype{L}{>{\raggedright\arraybackslash}X}
    \begin{adjustwidth}{-\extralength}{0cm}
 	\begin{tabularx}{\fulllength}{lllllllllllL}
    \toprule
        \textbf{cat\#} & \textbf{Class 1} & \textbf{Class 2} & \textbf{Class 3} & \textbf{Class 4} & \textbf{Class 5} & \textbf{Class 6} & \textbf{Class 7} & \textbf{Class 8} & \textbf{Class 9} & \textbf{Class 10} & \textbf{RowSum} \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 1 & 683,544 & 309,023 & 99,294 & 155,266 & 51,772 & 166,487 & 46,734 & 33,393 & 90,153 & 1763 & 1,637,429 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 2 & 140,068 & 1,405,103 & 502,303 & 960,693 & 301,650 & 1969 & 244,355 & 7645 & 463,950 & 15,581 & 4,043,317 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 3 & 34,985 & 29,270 & 6265 & 56,130 & 239,734 & 1,980,369 & 393,702 & 256,511 & 33,095 & 39,034 & 3,069,095 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 4 & 37,825 & 13,154 & 4829 & 51,406 & 404,025 & 3,157,656 & 857,426 & 692,151 & 43,581 & 53,723 & 5,315,776 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 5 & 138,477 & 671,024 & 2,455,571 & 568,894 & 34,995 & 1184 & 15,184 & 5799 & 152,695 & 3956 & 4,047,779 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 6 & 51,528 & 717,269 & 267,346 & 1,543,446 & 1,005,959 & 256,180 & 637,860 & 126,776 & 660,357 & 42,351 & 5,309,072 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 7 & 18,831 & 12,591 & 2094 & 90,961 & 386,704 & 1,777,537 & 1,583,559 & 956,054 & 54,353 & 31,397 & 4,914,081 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 8 & 44,343 & 134,707 & 147,092 & 1,003,947 & 1,035,822 & 832,105 & 1,440,973 & 404,912 & 853,895 & 42,981 & 5,940,777 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 9 & 19,763 & 43,411 & 10,566 & 249,256 & 272,111 & 597,942 & 1,194,978 & 989,956 & 638,501 & 9637 & 4,026,121 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 10 & 18,842 & 61,878 & 10,717 & 128,166 & 71,966 & 106,674 & 222,352 & 605,939 & 610,029 & 6357 & 1,842,920 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        ColSum & 1,188,206 & 3,397,430 & 3,506,077 & 4,808,165 & 3,804,738 & 8,878,103 & 6,637,123 & 4,079,136 & 3,600,609 & 246,780 & 40,146,367 \\ %\midrule
...
%\footnotesize
    %\centering
    \caption{Calculated error matrix and kappa parameter for accuracy assessment of the classification results for Landsat 8 image on 2021 using `r.kappa' module of GRASS GIS.}%\label{tab03}} % Author's reply: yes, bold can be removed (I removed it).
\newcolumntype{L}{>{\raggedright\arraybackslash}X}
    \begin{adjustwidth}{-\extralength}{0cm}
 	\begin{tabularx}{\fulllength}{lllllllllllL}
    \toprule
                \textbf{cat\#} & \textbf{Class 1} & \textbf{Class 2} & \textbf{Class 3} & \textbf{Class 4} & \textbf{Class 5} & \textbf{Class 6} & \textbf{Class 7} & \textbf{Class 8} & \textbf{Class 9} & \textbf{Class 10} & \textbf{RowSum} \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 1 & 702,916 & 170,016 & 144,023 & 121,055 & 160,622 & 146,539 & 319,847 & 201,335 & 17,125 & 11,327 & 1,994,805 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 2 & 137,245 & 772,838 & 405,525 & 861,919 & 482,726 & 297,935 & 637,744 & 319,340 & 133,967 & 40,635 & 4,089,874 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 3 & 100,084 & 553,381 & 1,979,310 & 375,399 & 32,820 & 15,876 & 19,359 & 17,344 & 62,178 & 772 & 3,156,523 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 4 & 52,869 & 1,280,901 & 736,804 & 1,341,217 & 227,239 & 203,122 & 179,091 & 173,844 & 332,915 & 21,818 & 4,549,820 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 5 & 31,298 & 348,878 & 82,337 & 988,002 & 669,137 & 367,343 & 590,315 & 179,041 & 732,481 & 23,781 & 4,012,613 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 6 & 82,156 & 20,454 & 2383 & 73,286 & 843,448 & 2,928,722 & 1,185,373 & 683,802 & 52,542 & 112,618 & 5,984,784 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 7 & 14,080 & 2677 & 12 & 10,134 & 199,861 & 3,664,407 & 1,106,320 & 869,961 & 27,095 & 16,303 & 5,910,850 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 8 & 11,133 & 3988 & 2954 & 140,173 & 514,342 & 987,416 & 1,809,103 & 776,155 & 79,990 & 9808 & 4,335,062 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 9 & 53,852 & 247,468 & 154,669 & 881,230 & 602,744 & 79,115 & 361,528 & 69,245 & 1,863,006 & 6719 & 4,319,576 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 10 & 2991 & 1500 & 291 & 19,321 & 73,820 & 188,976 & 432,371 & 791,227 & 303,449 & 3076 & 1,817,022 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        ColSum & 1,188,624 & 3,402,101 & 3,508,308 & 4,811,736 & 3,806,759 & 8,879,451 & 6,641,051 & 4,081,294 & 3,604,748 & 246,857 & 40,170,929 \\ %\midrule      
          \noalign{\hrule height 1.0pt} 
    \end{tabularx}
    \end{adjustwidth}
\end{table}
...
%\footnotesize
    %\centering
    \caption{Calculated error matrix and kappa parameter for accuracy assessment of the classification results for Landsat 8 image on 2022 using `r.kappa' module of GRASS GIS.}%\label{tab03}} % Author's reply: yes, bold can be removed (I removed it).
\newcolumntype{L}{>{\raggedright\arraybackslash}X}
    \begin{adjustwidth}{-\extralength}{0cm}
 	\begin{tabularx}{\fulllength}{lllllllllllL}
    \toprule
         \textbf{cat\#} & \textbf{Class 1} & \textbf{Class 2} & \textbf{Class 3} & \textbf{Class 4} & \textbf{Class 5} & \textbf{Class 6} & \textbf{Class 7} & \textbf{Class 8} & \textbf{Class 9} & \textbf{Class 10} & \textbf{RowSum} \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 1 & 731,146 & 290,319 & 237,623 & 291,223 & 132,078 & 263,431 & 319,057 & 187,293 & 56,788 & 22,701 & 2,531,659 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 2 & 35,991 & 11,448 & 5617 & 16,586 & 180,690 & 2,141,375 & 456,161 & 458,916 & 27,192 & 49,483 & 3,383,459 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 3 & 18,712 & 5274 & 1374 & 21,109 & 225,586 & 2,424,597 & 624,656 & 524,088 & 18,643 & 21,329 & 3,885,368 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 4 & 130,449 & 1,176,764 & 483,567 & 1,149,433 & 546,547 & 352,960 & 717,444 & 317,804 & 486,570 & 39,343 & 5,400,881 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 5 & 30,884 & 35,859 & 16,397 & 213,410 & 535,419 & 1,358,447 & 1,173,149 & 582,758 & 40,234 & 37,240 & 4,023,797 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 6 & 26,411 & 18,092 & 8246 & 150,852 & 504,812 & 1,178,353 & 1,640,165 & 765,099 & 49,838 & 32,619 & 4,374,487 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 7 & 53,164 & 1,017,166 & 636,794 & 1,598,491 & 736,672 & 375,514 & 548,660 & 219,776 & 849,537 & 30,208 & 6,065,982 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 8 & 108,133 & 594,918 & 1,948,383 & 348,009 & 32,300 & 59,628 & 18,387 & 25,360 & 138,083 & 1559 & 3,274,760 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 9 & 24,740 & 168,328 & 93,599 & 521,826 & 575,816 & 606,032 & 927,642 & 694,886 & 707,640 & 9358 & 4,329,867 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 10 & 32,749 & 110,613 & 91,007 & 522,968 & 352,275 & 131,057 & 246,218 & 329,246 & 1,254,761 & 3620 & 3,074,514 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        ColSum & 1,192,379 & 3,428,781 & 3,522,607 & 4,833,907 & 3,822,195 & 8,891,394 & 6,671,539 & 4,105,226 & 3,629,286 & 247,460 & 40,344,774 \\ %\midrule
     \noalign{\hrule height 1.0pt} 
    \end{tabularx}
    \end{adjustwidth}
\end{table}
...
%\footnotesize
    %\centering
    \caption{Calculated error matrix and kappa parameter for accuracy assessment of the classification results for Landsat 8 image on 2023 using `r.kappa' module of GRASS GIS.}%}%\label{tab03}} % Author's reply: yes, bold can be removed (I removed it).
\newcolumntype{L}{>{\raggedright\arraybackslash}X}
    \begin{adjustwidth}{-\extralength}{0cm}
 	\begin{tabularx}{\fulllength}{lllllllllllL}
    \toprule
        \textbf{cat\#} & \textbf{Class 1} & \textbf{Class 2} & \textbf{Class 3} & \textbf{Class 4} & \textbf{Class 5} & \textbf{Class 6} & \textbf{Class 7} & \textbf{Class 8} & \textbf{Class 9} & \textbf{Class 10} & \textbf{RowSum} \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 1 & 696,181 & 265,690 & 210,677 & 147,949 & 47,848 & 2351 & 28,532 & 11,048 & 318,677 & 916 & 1,729,869 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 2 & 149,373 & 875,176 & 345,372 & 679,954 & 298,325 & 17,823 & 276,754 & 36,126 & 491,199 & 13,422 & 3,183,524 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 3 & 68,987 & 1,103,574 & 616,225 & 1,449,488 & 384,491 & 27,522 & 383,103 & 58,688 & 592,878 & 31,005 & 4,715,961 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 4 & 113,808 & 718,554 & 1,928,287 & 399,929 & 82,193 & 29,429 & 53,107 & 31,572 & 253,169 & 1602 & 3,611,650 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 5 & 36,422 & 248,019 & 189,972 & 890,162 & 567,087 & 292,147 & 1,021,289 & 370,809 & 523,327 & 29,114 & 4,168,348 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 6 & 44,185 & 40,446 & 42,802 & 309,544 & 969,941 & 1,256,540 & 1,076,897 & 398,925 & 377,458 & 54,559 & 4,571,297 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 7 & 51,650 & 18,914 & 13,974 & 115,112 & 323,824 & 4,387,107 & 966,427 & 899,834 & 55,327 & 72,308 & 6,904,477 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 8 & 17,292 & 54,481 & 80,843 & 400,775 & 627,113 & 1,343,379 & 1,726,289 & 675,519 & 195,048 & 23,051 & 5,143,790 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 9 & 9240 & 5475 & 4241 & 86,789 & 210,760 & 1,163,138 & 817,121 & 1,116,546 & 54,160 & 12,431 & 3,479,901 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        Class 10 & 7212 & 129,323 & 102,017 & 367,368 & 311,372 & 314,712 & 311,368 & 501,372 & 792,399 & 8292 & 2,845,435 \\ \hline
      &&&&&&&&&&&\\[-2ex]
        ColSum & 1,194,350 & 3,459,652 & 3,534,410 & 4,847,070 & 3,822,954 & 8,834,148 & 6,660,887 & 4,100,439 & 3,653,642 & 246,700 & 40,354,252 \\ %\midrule
     \noalign{\hrule height 1.0pt} 
    \end{tabularx}
    \end{adjustwidth}
\end{table}
...
The example is given for the scene on 2016. All the other reports are provided in the author's GitHub repository along with GRASS GIS scripts: \url{https://github.com/paulinelemenkova/Sudd_South_Sudan_Image_Analysis} (accessed on 10 August 2023).  %MDPI: Please provide the access date of the URL in the following format: "URL (accessed on Day Month Year)".
...
\newblock In Proceedings of the 2011 Third International Conference on
  Measuring Technology and Mechatronics Automation, Shanghai, China, 6-7 January 2011; Volume~2, pp.
  799--802.
...
\newblock In Proceedings of the IET International Conference on Information
  Science and Control Engineering 2012 (ICISCE 2012), Shenzhen, China, 07-09 December 2012; pp. 1--4.
...
\newblock In Proceedings of the 2012 IEEE International Geoscience and Remote
  Sensing Symposium, Munich, Germany, 22-27 July 2012; pp. 4319--4322.
...
\newblock In Proceedings of the IGARSS 2018---2018 IEEE International
  Geoscience and Remote Sensing Symposium, Valencia, Spain, 22-27 July 2018; pp. 717--720.
...
\newblock In Proceedings of the 2013 Seventh International Conference on
  Sensing Technology (ICST), Wellington, New Zealand, 03-05 December 2013; pp. 678--681.
...
\newblock In Proceedings of the IGARSS 2004. 2004 IEEE International Geoscience
  and Remote Sensing Symposium, Anchorage, AK, 20-24 September 2004; Volume~5, \linebreak pp. 3062--3065.
...
\newblock In Proceedings of the 2004 International Conference on Image
  Processing, ICIP '04, Singapore, 24-27 October 2004; Volume~5, pp. 3351--3354.
...
\newblock In Proceedings of the 2017 10th International Congress on Image and
  Signal Processing, BioMedical Engineering and Informatics (CISP-BMEI), Shanghai, China, 14-16 October 2017;
  pp. 1--5.
...
\newblock In Proceedings of the 2020 28th Signal Processing and Communications
  Applications Conference (SIU), Istanbul, Turkey, 5-7 October 2020; pp. 1--4.
...
\newblock In Proceedings of the 2010 International Conference on Signal
  Acquisition and Processing, Bangalore, India,  09-10 February 2010; pp. 73--75.
...
\newblock In Proceedings of the 2023 Third International Conference on
  Artificial Intelligence and Smart Energy (ICAIS), Coimbatore, India, 02-04 February 2023; pp. 704--709.
...
\newblock In Proceedings of the 2017 International Conference on Image and
  Vision Computing New Zealand (IVCNZ), Christchurch, New Zealand, 04-06 December 2017; pp. 1--6.
...
\newblock In Proceedings of the 2020 International Conference on Electrical and
  Information Technologies (ICEIT), Rabat, Morocco, 04-07 March 2020; pp. 1--3.
...
\newblock In {\em Architecture‐Aware Optimization Strategies in Real‐Time
  Image Processing}; John Wiley \& Sons, Ltd.: Hoboken, NJ, USA,  % Author's reply: agree with new added information.
...
\newblock In {\em Image Segmentation}; John Wiley \& Sons, Ltd.: Hoboken, NJ, USA, 2022; % Author's reply: agree with new added information.
...
\newblock Chapter 17 Geomorphometry in GRASS GIS. In {\em Geomorphometry}; {Developments in
  Soil Science}; 
  Hengl, T., Reuter, H.I., Eds.; Elsevier.: Amsterdam, The Netherlands, %We added the location of publisher. Please confirm % Author's reply: agree with new added information.
...
\newblock In {\em Large Rivers}; John Wiley \& Sons, Ltd.: Hoboken, NJ, USA, % Author's reply: agree with new added information.
  2022; Chapter~24,
  pp. 704--736.
...
Whiteman, A.J.
\newblock \emph{Geology of the Sudan Republic}; Cambridge University Press, Cambridge, UK, 1971. %MDPI: Please add the name of the publisher and their location.
...
\newblock In {\em Large Rivers}; John Wiley \& Sons, Ltd.:  Hoboken, NJ, USA,  2022; Chapter~14, % Author's reply: agree with new added information.
  pp. 388--432.
...
Assessment, M.E.
\newblock {\em Ecosystems and Human Well-Being: Wetlands and Water}; World
  Resources Institute: Washington DC, U.S. %MDPI: Please add the location of the publisher (City and Country). % Author's reply: yes, added.
  2005.
...
\newblock Available online: \url{https://www.oneearth.org/ecoregions/sudd-flooded-grasslands/} (accessed on 10 August 2023). %MDPI: Please add the access date (format: Date Month Year), e.g., accessed on 1 January 2020. % Author's reply: yes, added.
...
\newblock Online.  2023.
\newblock
  Available online: \url{https://climateknowledgeportal.worldbank.org/country/sudan/climate-data-historical} (accessed on 8 August 2023).
...
\newblock Online,  2014.
\newblock Available online: \url{https://m.reliefweb.int/disaster/14337/fl-2014-000123-ssd?lang=fr} (accessed on 9 August 2023).

\bibitem[ReliefWeb(2018)]{ReliefWeb2018}
ReliefWeb.
\newblock Sudan: Floods---July 2018.
\newblock Online.  2018.
\newblock Available online: \url{https://reliefweb.int/disaster/fl-2018-000128-sdn} (accessed on 11 August 2023).
...
\newblock Online.  2019.
\newblock
  Available online: \url{https://reliefweb.int/report/south-sudan/south-sudan-floods-emergency-response-strategy-and-funding-requirements-14} (accessed on 11 August 2023).
...
\newblock Available online: URL: https://www.unocha.org/ (accessed on 10 August 2023). %MDPI: Please add URL and the access date. % Author's reply: yes, added.
...
\newblock Available online: \url{https://southsudan.crisisgroup.org/} (accessed on 10 August 2023).

\bibitem[ReliefWeb(2022)]{ReliefWeb}
ReliefWeb.
\newblock South Sudan: Floods 2021--2022.
\newblock Online.  2022.
\newblock Available online: \url{Https://reliefweb.int/disaster/fl-2021-000108-ssd} (accessed on 10 August 2023).
...
\newblock Available online: URL: https://www.afro.who.int/health-topics/disease-outbreaks/outbreaks-and-other-emergencies-updates (accessed on 10 August 2023). %MDPI: Please add URL and the access date.
...
\newblock {\em Water Resour. Res.} {\bf 2005}, {\em 41},~1-14. %MDPI: Please add the page number. % Author's reply: yes, added.
